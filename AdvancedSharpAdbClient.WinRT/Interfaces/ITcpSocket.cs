...
namespace AdvancedSharpAdbClient.WinRT
{
    ...
    public interface ITcpSocket : IDisposable
    {
        ...
        /// </summary>
        /// <param name="host">The host address that represents the remote device.</param>
        /// <param name="port">The port that represents the remote device.</param>
        ...
        int Send([ReadOnlyArray] byte[] buffer, int offset, int size, SocketFlags socketFlags);
        ...
        int Receive([WriteOnlyArray] byte[] buffer, int size, SocketFlags socketFlags);

        /// <summary>
        /// Gets the underlying <see cref="IRandomAccessStream"/>.
        /// </summary>
        /// <returns>The underlying stream.</returns>
        IRandomAccessStream GetStream();
    }
}
