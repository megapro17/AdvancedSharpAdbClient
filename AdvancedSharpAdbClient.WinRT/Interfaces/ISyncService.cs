...
namespace AdvancedSharpAdbClient.WinRT
{
    ...
    public interface ISyncService : IDisposable
    {
        ...
        void Push(IInputStream stream, string remotePath, int permissions, DateTimeOffset timestamp, AsyncActionProgressHandler<int> progress);
        ...
        /// <param name="progress">An optional parameter which, when specified, returns progress notifications. The progress is reported as a value between 0 and 100, representing the percentage of the file which has been transferred.</param>
        void Pull(string remotePath, IOutputStream stream, AsyncActionProgressHandler<int> progress);
