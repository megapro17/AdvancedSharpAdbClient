...
namespace AdvancedSharpAdbClient.WinRT
{
    ...
    public interface IAdbSocket : IDisposable
    {
        ...
        void Send([ReadOnlyArray] byte[] data, int length);
        ...
        /// <param name="length">The number of bytes to send.</param>
        void Send([ReadOnlyArray] byte[] data, int offset, int length);
        ...
        int Read([WriteOnlyArray] byte[] data);
        ...
        int Read([WriteOnlyArray] byte[] data, int length);
        ...
        /// <summary>
        /// Gets a <see cref="IRandomAccessStream"/> that can be used to send and receive shell output to and
        /// from the device.
        /// </summary>
        /// <returns>
        /// A <see cref="IRandomAccessStream"/> that can be used to send and receive shell output to and
        /// from the device.
        /// </returns>
        IRandomAccessStream GetShellStream();
